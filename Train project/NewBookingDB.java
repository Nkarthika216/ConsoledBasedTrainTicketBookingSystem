// compile   :  javac -cp "C:\Users\Lenovo\Downloads\postgresql-42.6.0.jar;" BookingWithDB.java
        ...
        while(flag){
            ...
            switch(choice){
               ...
               loop=isValidPassword(password);
                ...
                // ????
                System.out.println("Hiiiii");
                boolean signUpStatus=utilObj.signUp(new User(name,dob,mail_id,password,phone_no));
                if(signUpStatus)
